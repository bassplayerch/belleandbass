...
const getPathFromProps = props =>
  props.pageResources && props.pageResources.page ? props.pageResources.page.path : undefined;
...
class JSONStore extends _react.default.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return (
      ...
      this.state.pageQueryData[nextState.path] !== nextState.pageQueryData[nextState.path] ||
